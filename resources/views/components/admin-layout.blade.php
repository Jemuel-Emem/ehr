    ...
    <aside id="sidebar-multi-level-sidebar" class="sidebar fixed top-0 left-0 z-40 w-64 h-screen transition-transform sm:translate-x-0" aria-label="Sidebar">
        <div class="h-full px-3 py-4 overflow-y-auto">
            <div class="text-center flex flex-col items-center">
                <img src="{{asset('images/hospital.png')}}" alt="Admin">
                <div class="font-bold  text-2xl">EHR</div>
            </div>
            <ul class="space-y-2 font-medium mt-4">
                ...
                <li>
                    <a href="{{route('add-p')}}" class="flex items-center p-2 rounded-lg hover:bg-gray-700">
                        <i class="ri-file-add-fill"></i>
                        <span class="ms-3">Add Patients</span>
                    </a>
                </li>
                <li>
                    <a href="{{route('patients-rec')}}" class="flex items-center p-2 rounded-lg hover:bg-gray-700">
                        <i class="ri-folder-history-fill"></i>
                        <span class="ms-3">Patients Records</span>
                    </a>
                </li>

                <li>
                    <a href="{{route('search-p')}}" class="flex items-center p-2 rounded-lg hover:bg-gray-700">
                        <i class="ri-search-eye-fill"></i>
                        <span class="ms-3">Search Patients</span>
                    </a>
                </li>
